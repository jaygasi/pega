...
import StyledJaygasiLlcExtensionSearchJaygasiWrapper from './styles';

// interface for props
interface JaygasiLlcExtensionSearchJaygasiProps extends PConnFieldProps {
...
interface JaygasiLlcExtensionSearchJaygasiPropsSubSet {
  selected: any;
  actualValue: any;
  isTableFormatter?: boolean;
  formatter: string;
...
const DisplayComponent = (props: JaygasiLlcExtensionSearchJaygasiPropsSubSet) => {
...
function JaygasiLlcExtensionSearchJaygasi(props: JaygasiLlcExtensionSearchJaygasiProps) {
  const {
    getPConnect,
    value,
    placeholder,
  ...
  const displayComponent = useMemo(() => {
    return <StyledJaygasiLlcExtensionSearchJaygasiWrapper>
    <DisplayComponent {...{ selected, actualValue, isTableFormatter, formatter }} />
    </StyledJaygasiLlcExtensionSearchJaygasiWrapper>;
...
export default withConfiguration(JaygasiLlcExtensionSearchJaygasi);
