...
import AnyExtTwoColumnForm from './index';
...
const meta: Meta<typeof AnyExtTwoColumnForm> = {
  title: 'Jaygasi/TwoColumnForm',
  component: AnyExtTwoColumnForm,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'TwoColumnForm'
  }
...
export default meta;
type Story = StoryObj<typeof AnyExtTwoColumnForm>;
...
export const BaseAnyExtTwoColumnForm: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <AnyExtTwoColumnForm {...props} {...args}>
      {[regionAChildren, regionBChildren]}
    </AnyExtTwoColumnForm>
  );
};

BaseAnyExtTwoColumnForm.args = {
  readOnly: false,
  showLabel: true,
