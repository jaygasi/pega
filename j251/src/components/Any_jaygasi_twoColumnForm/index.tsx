...
import StyledAnyExtTwoColumnFormWrapper from './styles';

// interface for props
interface AnyExtTwoColumnFormProps extends PConnFieldProps {
...
function AnyExtTwoColumnForm(props: Readonly<AnyExtTwoColumnFormProps>) {
  ...
  if (readOnly && readOnly === true || displayMode && displayMode === 'DISPLAY_ONLY') {
    return (
      <StyledAnyExtTwoColumnFormWrapper>
...
export default withConfiguration(AnyExtTwoColumnForm);
