...
import AnyExtTextInputSearch from './index';
import type { AnyExtTextInputSearchProps } from './index';

import { configProps, stateProps, fieldMetadata } from './mock';

const meta: Meta<typeof AnyExtTextInputSearch> = {
  title: 'Jaygasi/TextInputSearch',
  component: AnyExtTextInputSearch,
  excludeStories: /.*Data$/,
  parameters: {
    docs: {
...
export default meta;
type Story = StoryObj<typeof AnyExtTextInputSearch>;

const getMockProps = (overrides: Partial<AnyExtTextInputSearchProps> = {}) => {
  return {
...
export const BaseAnyExtTextInputSearch = (args: AnyExtTextInputSearchProps) => {
  ...
  return (
    <>
      <AnyExtTextInputSearch {...props} />
    </>
  );
};

BaseAnyExtTextInputSearch.args = {
...
export const DisplayOnlyMode = (args: AnyExtTextInputSearchProps) => {
  return (
    <>
      <AnyExtTextInputSearch {...getMockProps({ ...args, displayMode: 'DISPLAY_ONLY', value: 'Sample Value' })} />
    </>
  );
};

DisplayOnlyMode.args = { ...BaseAnyExtTextInputSearch.args };

export const ErrorState = (args: AnyExtTextInputSearchProps) => {
  return (
    <>
      <AnyExtTextInputSearch {...getMockProps({ ...args, validatemessage: 'Invalid input' })} />
    </>
  );
};

ErrorState.args = { ...BaseAnyExtTextInputSearch.args };