...
import JaygasiExtensionsPDFViewerAdvanced from './index';
// reuse the sample base64 from the existing pdfViewer mock
import { configProps as pdfViewerMockConfig } from './mock';
...
const StorybookWrapper = (args: any) => {
  ...
  return <JaygasiExtensionsPDFViewerAdvanced
    getPConnect={() => mockPConnectWithArgs}
    label="PDF Viewer"
    required={false}
    disabled={false}
    value=""
...
const meta: Meta = {
  title: 'Jaygasi/PDFViewerAdvanced',
