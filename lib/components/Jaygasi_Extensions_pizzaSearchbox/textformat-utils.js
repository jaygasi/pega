...
const TableImage = imageProps => {
    ...
    imageDisplayComp = (_jsxs(_Fragment, { children: [btnVal !== null && (_jsx(Button, { ref: demoButtonRef, variant: 'link', compact: false, onClick: onClick, autoFocus: true, children: btnVal })), images && (_jsx(Lightbox, { items: images, cycle: false, onAfterClose: () => {
                    setImages(null);
