...
export const getDayJSObject = (text) => {
    ...
    // @ts-ignore
    mom = dayjs(mom.toLocaleString("en-US", {
        timeZone: CurrentTz
    }));
    return mom;
};
 ...
 */
export const getFullYear = (value) => value ? new Date(value).getFullYear() : new Date().getFullYear();
/**
 ...
 */
export const parseClockFormat = (clockFormat) => typeof clockFormat === "string" ? parseInt(clockFormat, 10) : clockFormat;
/**
 ...
 * @returns {void}
 */
export const datetimeFireChangeBlurEvents = (errorState, actualValue, formattedValue, actions, propName, pConn) => {
