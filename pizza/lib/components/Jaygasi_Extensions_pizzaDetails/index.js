...
import StyledJaygasiExtensionsPizzaDetailsWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';
// includes in bundle
import { getAllFields } from './utils';
// props passed in combination of props from property panel (config.json) and run time props from Constellation
// any default values in config.pros should be set in defaultProps at bottom of this file
function JaygasiExtensionsPizzaDetails(props) {
    ...
    return (_jsx(StyledJaygasiExtensionsPizzaDetailsWrapper, { children: _jsxs(FieldGroup, { name: propsToUse.showLabel ? propsToUse.label : '', children: [showHighlightedData && highlightedDataArr.length > 0 && (_jsxs(_Fragment, { children: [_jsx(Flex
                        // @ts-ignore
                        , { 
                            // @ts-ignore
                            container: { direction: 'row', alignItems: 'normal', colGap: 10 }, "data-testid": `highlighted-column-count-${numRegions}`, children: highlightedDataArr.map((child, i) => (_jsx(Fragment, { children: child }, `hf-${i + 1}`))) }), _jsx(StyledHighlightedFieldsHrLine, {})] })), _jsx(Grid, { as: StyledDetailsGridContainer, container: gridContainer, "data-testid": `column-count-${numRegions}`, children: children.map((child, i) => (_jsx(Flex
                    // @ts-ignore
                    , { 
                        // @ts-ignore
