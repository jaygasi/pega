...
import JaygasiExtensionsPizzaTwoColumnDetails from './index';
...
export default meta;
type Story = StoryObj<typeof JaygasiExtensionsPizzaTwoColumnDetails>;
...
export const BaseJaygasiExtensionsPizzaTwoColumnDetails: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <JaygasiExtensionsPizzaTwoColumnDetails {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
    </JaygasiExtensionsPizzaTwoColumnDetails>
  );
};

BaseJaygasiExtensionsPizzaTwoColumnDetails.args = {
  showLabel: true,
