...
// interface for props
interface JaygasiExtensionsPizzaIconButtonUrlProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaIconButtonUrl(props: JaygasiExtensionsPizzaIconButtonUrlProps) {
  ...
  if (displayMode === 'DISPLAY_ONLY') {
    ...
    return (
      <StyledJaygasiExtensionsPizzaIconButtonUrlWrapper> {displayComp} </StyledJaygasiExtensionsPizzaIconButtonUrlWrapper>
    );
  }

  return (
    <StyledJaygasiExtensionsPizzaIconButtonUrlWrapper>
