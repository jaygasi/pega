...
import JaygasiExtensionsPizzaForm from './index';
...
const meta: Meta<typeof JaygasiExtensionsPizzaForm> = {
  title: 'JaygasiExtensionsPizzaForm',
  component: JaygasiExtensionsPizzaForm,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof JaygasiExtensionsPizzaForm>;
...
export const BaseJaygasiExtensionsPizzaForm: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <JaygasiExtensionsPizzaForm {...props} {...args}>{regionAChildren}</JaygasiExtensionsPizzaForm>
    </>
  );
};

BaseJaygasiExtensionsPizzaForm.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1,
