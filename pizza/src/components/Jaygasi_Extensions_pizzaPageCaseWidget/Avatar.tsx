...
// interface for props
interface JaygasiExtensionsPizzaPageCaseWidgetAvatarProps extends PConnFieldProps {
...
function Avatar(props: JaygasiExtensionsPizzaPageCaseWidgetAvatarProps) {
