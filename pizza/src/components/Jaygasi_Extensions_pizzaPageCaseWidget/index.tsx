...
// interface for props
interface JaygasiExtensionsPizzaPageCaseWidgetProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaPageCaseWidget(props: JaygasiExtensionsPizzaPageCaseWidgetProps) {
  ...
  return user.userId && user.userName ? (
    <StyledJaygasiExtensionsPizzaPageCaseWidgetWrapper>
      <Card>
