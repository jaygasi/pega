...
// interface for props
interface JaygasiExtensionsTextWithEmojiProps extends PConnFieldProps {
...
function JaygasiExtensionsTextWithEmoji(props: Readonly<JaygasiExtensionsTextWithEmojiProps>) {
  const { 
    getPConnect, 
    value, 
    placeholder, 
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledJaygasiExtensionsTextWithEmojiWrapper data-display-mode="DISPLAY_ONLY"> 
        {displayComp} 
      </StyledJaygasiExtensionsTextWithEmojiWrapper>
    ) : (
      <StyledJaygasiExtensionsTextWithEmojiWrapper data-display-mode="LABELS_LEFT">
        <FieldValueList
  ...
  if (displayMode === 'STACKED_LARGE_VAL') {
    ...
    return (
      <StyledJaygasiExtensionsTextWithEmojiWrapper data-display-mode="STACKED_LARGE_VAL">
        <FieldValueList
          variant='stacked'
          data-testid={testId}
  ...
  return (
    <StyledJaygasiExtensionsTextWithEmojiWrapper data-display-mode="EDIT">
      <Input
        type='text'
        value={inputValue}
        label={label}
