...
import JaygasiExtensionsTextWithEmoji from './index';

const meta: Meta<typeof JaygasiExtensionsTextWithEmoji> = {
  title: 'Jaygasi/Text with Emoji',
  component: JaygasiExtensionsTextWithEmoji,
  argTypes: {
    fieldMetadata: {
      table: {
        disable: true,
...
export default meta;
type Story = StoryObj<typeof JaygasiExtensionsTextWithEmoji>;
...
const StoryWrapper = ({ initialValue, ...args }: any) => {
  ...
  return <JaygasiExtensionsTextWithEmoji {...props} />;
};
