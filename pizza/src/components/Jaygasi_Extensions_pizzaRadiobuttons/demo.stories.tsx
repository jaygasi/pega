...
export default meta;
type Story = StoryObj<typeof JaygasiExtensionsPizzaRadiobuttons>;

export const BaseJaygasiExtensionsPizzaRadiobuttons: Story = (args: any) => {
  ...
  return (
    <>
      <JaygasiExtensionsPizzaRadiobuttons {...props} {...args} />
    </>
  );
};

BaseJaygasiExtensionsPizzaRadiobuttons.args = {
