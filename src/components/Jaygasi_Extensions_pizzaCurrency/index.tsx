...
// interface for props
interface JaygasiExtensionsPizzaCurrencyProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaCurrency(props: JaygasiExtensionsPizzaCurrencyProps) {
  const {
    getPConnect,
    value = 0,
    placeholder,
  ...
  if (
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledJaygasiExtensionsPizzaCurrencyWrapper> {displayComp} </StyledJaygasiExtensionsPizzaCurrencyWrapper>) ;
      }
      case 'LABELS_LEFT': {
        return (
