...
// interface for props
interface JaygasiExtensionsPizzaPageWidgetProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaPageWidget(props: JaygasiExtensionsPizzaPageWidgetProps) {
  ...
  return (
    <StyledJaygasiExtensionsPizzaPageWidgetWrapper>
    <PegaAppAnnouncement
      heading={header}
