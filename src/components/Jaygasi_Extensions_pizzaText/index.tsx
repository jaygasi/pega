...
function JaygasiExtensionsPizzaText(props: JaygasiExtensionsPizzaTextProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledJaygasiExtensionsPizzaTextWrapper> {displayComp} </StyledJaygasiExtensionsPizzaTextWrapper>
    ) : (
      <StyledJaygasiExtensionsPizzaTextWrapper>
        <FieldValueList
