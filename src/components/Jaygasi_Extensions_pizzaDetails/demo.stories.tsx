...
import JaygasiExtensionsPizzaDetails from './index';
...
const meta: Meta<typeof JaygasiExtensionsPizzaDetails> = {
  title: 'JaygasiExtensionsPizzaDetails',
  component: JaygasiExtensionsPizzaDetails,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof JaygasiExtensionsPizzaDetails>;
...
export const BaseJaygasiExtensionsPizzaDetails: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <JaygasiExtensionsPizzaDetails {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </JaygasiExtensionsPizzaDetails>
    </>
  );
};

BaseJaygasiExtensionsPizzaDetails.args = {
  showLabel: true,
