...
// interface for props
interface JaygasiExtensionsPizzaDetailsProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaDetails(props: JaygasiExtensionsPizzaDetailsProps) {
  ...
  return (
    <StyledJaygasiExtensionsPizzaDetailsWrapper>
