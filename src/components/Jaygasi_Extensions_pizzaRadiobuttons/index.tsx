...
// interface for props
interface JaygasiExtensionsPizzaRadiobuttonsProps extends PConnFieldProps {
...
function JaygasiExtensionsPizzaRadiobuttons(props: JaygasiExtensionsPizzaRadiobuttonsProps) {
  const {
    getPConnect,
    value,
    label,
  ...
  return (
    <StyledJaygasiExtensionsPizzaRadiobuttonsWrapper>
    <RadioButtonGroup
      {...additionalProps}
      label={label}
